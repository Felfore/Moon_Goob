...
action-desc-floor-scrubber-fill = Fill the clean water tank from a nearby sink.
floor-scrubber-fill-no-key = The key is missing!

# HUD Alerts
alerts-floor-scrubber-clean-name = Clean Water Tank
alerts-floor-scrubber-clean-desc = Remaining clean water for scrubbing.

alerts-floor-scrubber-waste-name = Waste Tank
alerts-floor-scrubber-waste-desc = Collected waste fluids in the tank. Empty using a bucket or at a drain!
...
floor-scrubber-dump-drain-overflow = The drain overflowed. Some waste spilled on the floor. Where's your plunger?
...
# Fill messages
floor-scrubber-fill-full = The water tank is already full.
